...
export const ExperiencePage: React.FC<ExperiencePageProps> = ({ onNavigate }) => {
  const skills = [
    { name: 'System Architecture', pct: 95, label: 'Advanced' },
    { name: 'Cloud Infrastructure (AWS/GCP)', pct: 78, label: 'Proficient' },
    { name: 'Data Engineering / SQL', pct: 80, label: 'Proficient' },
    { name: 'API Design', pct: 88, label: 'Proficient' },
  ];
  ...
  return (
    <div style={{ backgroundColor: '#F7EFF7', minHeight: '100vh', paddingTop: '56px' }} className="page-enter">
      <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '0 20px' }}>
            ...
            <div style={{ position: 'relative', paddingLeft: '28px' }}>
              ...
              <div style={{ position: 'relative', marginBottom: '36px' }}>
                ...
                <div style={{ fontSize: '13px', color: '#9E8F9E', marginBottom: '8px' }}>
                  Fintech Scaleup · 2022 — Present
                </div>
                <p style={{ fontSize: '13px', color: '#6B5E6B', lineHeight: '1.5', marginBottom: '12px' }}>
                  Orchestrated enterprise payments gateway migration processing $450M+ annual volume. Led 14 engineers in decomposing legacy monolith into 6 AWS microservices with zero downtime.
                </p>
                <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                  <span className="chip-tag chip-tag-light">API Design</span>
                  <span className="chip-tag chip-tag-light">Microservices</span>
                  <span className="chip-tag chip-tag-light">AWS</span>
                </div>
              </div>

              {/* Entry 2 (Inactive Dot) */}
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ fontSize: '13px', color: '#9E8F9E', marginBottom: '8px' }}>
                  PropertyBridge · 2019 — 2022
                </div>
                <p style={{ fontSize: '13px', color: '#9E8F9E', lineHeight: '1.5' }}>
                  Spearheaded real-time real estate data pipeline rebuild. Standardized multi-tenant Kafka streaming architecture serving 14 regional MLS providers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                  ...
                  />
                  <div>
                    <div style={{ fontSize: '14px', fontWeight: 700, color: '#0D0B14' }}>
        ...
        >
          {/* Left Column: Watermark CTA */}
          <div>
            {/* Purely decorative background watermark letters */}
            <div
              style={{
                fontSize: '120px',
                fontWeight: 800,
            ...
            {/* CTA Content sitting BELOW the IO watermark letters */}
            <div>
              <h2
                style={{
                  fontSize: '26px',
          ...
          {/* Right Column: Contact Form in White Card */}
          <div
            style={{
              backgroundColor: '#FFFFFF',
